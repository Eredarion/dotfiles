...
///---Offsets---///
static const uint8_t offsets[] = {0,23,0,23};
///---Colors---///
...
static const uint8_t borders[] = {3,5,10,0};
...
static const char *menucmd[]   = { "/home/ranguel/bin/rofr.sh", "-r", NULL };
static const char *menuquit[]   = { "/home/ranguel/bin/rofr.sh", "-l", NULL };
static const char *xsmonitor[]  = { "xfce4-taskmanager", NULL, };
static const char *rofir[] = {"/home/ranguel/bin/rofr.sh", "-r", NULL};
static const char *rofiw[] = {"/home/ranguel/bin/rofr.sh", "-l", NULL};
...
static key keys[] = {
    ...
    {  MOD ,              XK_z,          start,             {.com = menucmd}},
    {  MOD ,              XK_t,          start,             {.com = xsmonitor}},
    {  MOD |SHIFT,        XK_q,          start,             {.com = menuquit}},
    {  MOD ,              XK_i,          start,             {.com = rofiw}},
    {  MOD ,              XK_d,          start,             {.com = rofir} },
    // light
    {  MOD1 ,             XK_Up,         start,             {.com = brightness_up} },
    {  MOD1 ,             XK_Down,       start,             {.com = brightness_down} },
    // volume 
    {  MOD1 ,             XK_Right,      start,             {.com = vol_up} },
    {  MOD1 ,             XK_Left,       start,             {.com = vol_down} },
