...
-- }}}
    ...
    -- Volume ---------------------------------------------------------------------------------
    awful.key({ altkey,           }, "Up", function () awful.spawn("pamixer -i 3") end,
              {description = "inc volume", group = "volume"}),

    awful.key({ altkey,           }, "Down", function () awful.spawn("pamixer -d 3") end,
              {description = "dec volume", group = "volume"}),
    -------------------------------------------------------------------------------------------

    -- Light ----------------------------------------------------------------------------------
    awful.key({ altkey,           }, "Right", function () awful.spawn("xbacklight -inc 10") end,
              {description = "inc light", group = "light"}),

    awful.key({ altkey,           }, "Left", function () awful.spawn("xbacklight -dec 10") end,
