...
box_image.image = "/home/ranguel/Downloads/up-arrow.svg"

local image_upload = wibox.widget.imagebox()
image_upload.image = "/home/ranguel/.config/awesome/themes/skyfall/icons/upload.svg"
------------------------------------------------------------
...
local graph_widget_upload = wibox.widget {
    ...
    --     shape.partially_rounded_rect(cr, width, height, true, true, false, false, 6)
    -- end,
...
align_vertical:set_middle(wibox.container.margin(graph_widget, dpi(1), dpi(1), 0, 0))
...
align_vertical_upload:set_middle(wibox.container.margin(graph_widget_upload, dpi(1), dpi(1), 0, 0))
...
area_upload:add(wibox.container.margin(align_vertical_upload, dpi(10), dpi(10), 0, 0))
------------------------------------------------------------
