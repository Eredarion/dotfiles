...
local xbackground = xrdb.background or	"#101423"
local xforeground = xrdb.foreground or	"#EEFFFF"
local xcolor0 = xrdb.color0 or	"#101423"
local xcolor1 = xrdb.color1 or	"#29518E"
local xcolor2 = xrdb.color2 or	"#AEA2B9"
local xcolor3 = xrdb.color3 or	"#D37E7E"
local xcolor4 = xrdb.color4 or	"#FBCFB5"
local xcolor5 = xrdb.color5 or	"#FCE2B9"
local xcolor6 = xrdb.color6 or	"#D5B4D4"
local xcolor7 = xrdb.color7 or	"#EEFFFF"
local xcolor8 = xrdb.color8 or	"#A08CBF"
local xcolor9 = xrdb.color9 or	"#F7B2AE"
local xcolor10 = xrdb.color10 or	"#AEA2B9"
local xcolor11 = xrdb.color11 or	"#D37E7E"
local xcolor12 = xrdb.color12 or	"#FBCFB5"
local xcolor13 = xrdb.color13 or	"#FCE2B9"
local xcolor14 = xrdb.color14 or	"#D5B4D4"
local xcolor15 = xrdb.color15 or	"#EEFFFF"
local xcolor16 = awesome.xrdb_get_value("", "color16") or	"#2A335A"

local accent_color = xcolor14
local focused_color = xcolor1
...
--theme.border_radius
theme.notification_border_color = xcolor0
theme.notification_bg = xcolor0
theme.notification_fg = xcolor7
theme.notification_crit_bg = urgent_color
theme.notification_crit_fg = xcolor0
theme.notification_margin = dpi(23)
theme.notification_icon_size = dpi(50)
theme.notification_height = dpi(80)
theme.notification_width = dpi(270)
